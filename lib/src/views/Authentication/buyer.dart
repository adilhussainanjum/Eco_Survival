...
class BuyerSingnup extends StatefulWidget {
  const BuyerSingnup({Key key}) : super(key: key);

  @override
  _BuyerSingnupState createState() => _BuyerSingnupState();
}

class _BuyerSingnupState extends State<BuyerSingnup> {
  double height;
  double width;
                      ...
                      CustomButton.myButton('Sign up', () async {
                        if (_formKey.currentState.validate()) {
                          ...
                          User user = await service.signupWithEmail(
                              ...
                              centerLocaton: _locationController.text,
